    ...
    <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4 mt-5">
            <div class="row g-3 mb-4 align-items-center justify-content-between">
                <div class="col-auto">
                    <h1 class="app-page-title mb-0">Créer patient</h1>
                </div>
                <div class="col-auto">
                        ...
                        <div class="app-card-body">
                            <form class="settings-form"  action="{{ route('creationpatient') }}" method="POST" >
                                ...
                                <div class="mb-1">
                                    ...
                                    <input type="text" style="text-transform: uppercase" class="form-control uppercase" name="code_patient" value="{{ $code_patient }}" {{ $code_patient }} readonly >
