...
<body>
                                ...
                                @auth()
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="user-dropdown-toggle">
                                        <li class="dropdown-item">
                                            {{ Str::upper(\Illuminate\Support\Facades\Auth::user()->name) }}</li>
        ...
        <div id="app-sidepanel" class="app-sidepanel">
            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <div class="app-branding">
                    <a class="app-logo" href="{{ route('laborantin-index') }}"><img class="logo-icon me-2" src="assets/images/app-logo.svg" alt="logo">
                        <span class="logo-text">Gestion Médicale</span>
                    </a>
                ...
                <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('laborantin-index') }}">
                                <span class="nav-icon">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="docs.html">
                                ...
                                <span class="nav-link-text">Dossiers</span>
                            </a>
                        </li>
                        <li class="nav-item">
    ...
    <footer class="app-footer">
        <div class="container text-center py-3">
            <small class="copyright">Designer avec &nbsp;<span class="sr-only"> </span> coeur &nbsp;<i
                    class="fas fa-heart" style="color: #fb866a;"></i>&nbsp; par Bestech Consult</small>
